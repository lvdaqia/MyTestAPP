...
public class VideoList {
    ...
    public List<VideoInfo> initVideoData() {
        mVideoInfos = new ArrayList<>();
        Cursor cursor = context.getContentResolver().query(Uri.parse("/mnt/sdcard2/CarRecord/"), sLocalVideoColumns,
                null, null, null);
     ...
     * @return
     */
    public String getVideoChannel(String title){
        String[] channel = title.split("_");
        return channel[1];
    }
}